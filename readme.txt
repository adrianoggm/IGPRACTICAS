...
MODO CAMARA TECLA C
	...
	TECLAS 0 1 2 CAMBIAS ENTRE CAMARAS 
	
MODO SELECCION 
	LAS FIGURAS PINTADAS EN MODOLINEAS SON SELECCIONABLES CON CLICK IZQ (CLICK IZQ A OTRA COSA PONDRA LA CAMARA CENTRADA AL ORIGEN)
	
	CLICK DERECHO +RATON PODRAS MOVERTE POR LA ESCENA SIN LA CRUCETA 
	
ZOOM  
	SE PUEDE REALIZAR DE DIVERSAS MANERAS (( RATON SCROLLING)) F1 F2  Y CON AVPAG REPAG  
